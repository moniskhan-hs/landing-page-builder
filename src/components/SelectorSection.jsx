...
const SelectorSection = ({ id, title, oldLabelValue, handleDragOver, handleDragStart, handleDrop, isDragged, index }) => {
    ...
    return (
        <Stack direction={'row'} sx={{
            ...
            <Box sx={{
                flex: 1,
                border: isExpanded ? `2px solid ${theme.palette.primary.main}` : `1px solid ${theme.palette.primary.light}`,
                borderRadius: "8px",
                        ...
                        {title !== 'THEME' && (<Box>
                            {addLableIsActive ? (
                                <Stack variant='center' >
                                    ...
                                    <IconButton
                                        onClick={() => setAddLableIsActive(false)}
                                ...
                                <Stack variant='center' >
                                    ...
                                    <TextField placeholder='Add label' variant='standard'
